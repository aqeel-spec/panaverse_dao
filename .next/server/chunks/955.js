...
/* harmony export */   "C": () => (/* binding */ specializationCourse),
/* harmony export */   "Vw": () => (/* binding */ detailSyllabus),
/* harmony export */   "ru": () => (/* binding */ courses),
/* harmony export */   "y0": () => (/* binding */ common)
/* harmony export */ });
const courses = [
    {
    ...
    `,
        ...
        q5: {
            quater: "V",
            Code: "MV-361",
            name: "Developing Planet-Scale Open Virtual and Augmented Metaverse Experiences"
        }
    },
    {
    ...
    },
    {
        ...
        q4: {
            quater: "IV",
            Code: "NPA-351",
            name: "CCNA 200-301 Certification"
        },
        q5: {
            quater: "V",
            Code: "NPA-361",
    ...
    },
    {
        ...
        q4: {
            quater: "IV",
            Code: "AC-351",
            name: "Ambient Computing with Voice Assistants and Matter Protocol Devices"
        },
        q5: {
            quater: "V",
            Code: "AC-361",
...
const detailSyllabus = [
    {
        ...
        quarterI: {
            ...
            duration: "13 Weeks",
            des: "We will start the program by learning the fundamentals of Object-Oriented programming using JavaScript and TypeScript. We will also understand the latest Web trends i.e. Web 3.0 and Metaverse concepts and try to understand their working from the perspective of the users.",
            ptOne: {
            ...
            ptTwo: {
                ...
                doc: "https://docs.google.com/presentation/d/12C1s4UBTlR9nZNEkRE6aAuGeRA3s92jx-8nJKo9jdH4/edit?usp=sharing",
                title2: "Web 3.0 User Guide",
                doc2: "https://docs.google.com/presentation/d/1FSbr9aJwO0-fmZHqWy_eHO2N_jwJLmQCy4cG8rd4ctw/edit?usp=sharing",
                name3: "Complete Web 3 Assignments included in the Web 3 User Guide",
                title3: "Virtual and Augmented  Metaverse User Guide",
                doc3: "https://docs.google.com/presentation/d/1ADk87hQ0Etr2PfmN9XH7TQ0CHl6XSP_7JWNUbzPdDNc/edit?usp=sharing"
            },
            ptThree: {
                ...
                des: "Chapters 2-6, 13 of JavaScript from Beginner to Professional: Learn JavaScript quickly by building fun, interactive, and dynamic web apps, games, and pages",
                bookLink: "https://www.amazon.com/JavaScript-Beginner-Professional-building-interactive/dp/1800562527/ref=sr_1_4",
                js: {
            ...
            ptFour: {
                ...
                chp: "Chapters 1-11 of Learning TypeScript: Enhance Your Web Development Skills Using Type-Safe JavaScript",
                ...
                ul: {
                    ...
                    name2: "In Class Companion projects and articles for Learning TypeScript",
            ...
            ptFive: {
                ...
                des: "Minimal TypeScript Crash Course For React With Interactive Code Exercises",
            ...
            quize1: {
                ...
                c: {
                    name: "Intro to Node.js, .mjs files, Modules, NPM, import, export, and using external modules with npm:",
                    link: "https://docs.google.com/presentation/d/1eOLJTN0FyVAw6lMUvA_XYLORKnudWXyzXsB6sg5oPIs/edit?usp=sharing"
                },
                d: {
                    name: "How to accept user input in your Node.js JavaScript programs, this will allow us to create interactive Node.js console programs using prompt-sync library. The last example in this presentation shows you how to use prompt-sync library in your Node.js programs:",
                    link: "https://docs.google.com/presentation/d/1eOLJTN0FyVAw6lMUvA_XYLORKnudWXyzXsB6sg5oPIs/edit?usp=sharing",
            ...
            qBreak: {
                ...
                endOfQuater: {
                    ...
                    detail: "Chapters 1, 2, 3, and 4 Learn Version Control with Git: A step-by-step course for the complete beginner by Tobias G\xfcnther ",
                    articles: {
        ...
        quater2: {
            id: 2,
            courseCode: "None",
            name: "W2-201: Developing Planet-Scale Web 2.0 Serverless Cloud Apps and APIs using Next.js 13 and Cloud Development Kit (CDK) for Terraform",
            duration: "13 Weeks",
            des: "The objective of this course is to teach participants to develop customer-facing planet-scale Websites, Full-Stack Apps and templates, Dashboards, and Muti-Cloud Serverless APIs. By the end of the quarter, the participants will be able to develop and deploy web platforms like Facebook, Shopify, etc. The technologies covered in this course will include Next.js 13, Figma, Tailwind CSS, Chakra UI, tRPC, QraphQL, Prisma, Cockroachdb Serverless (PostgreSQL Compatible), AWS Serverless Technologies, and Cloud Development Kit for Terraform (CDKTF).",
            Course_Outline: {
                pt1: {
                ...
                pt2: {
                    ...
                    t1: "CSS Flexbox Explained – Complete Guide to Flexible Containers and Flex Items",
                    t2: "Chakra UI Docs"
                },
                pt3: {
                    name: "UI/UX Design with Figma, TailwindCSS, and Chakra UI (Remote  Zoom Class)",
                    t1: "Designing and Prototyping Interfaces with Figma: Learn essential UX/UI design principles by creating interactive prototypes for mobile, tablet, and desktop by Fabio Staiano",
                    t2: "Figma Design Kit for TailwindCSS",
                    t3: "Chakra UI Figma Kit",
                    l1: "https://www.amazon.com/Designing-Prototyping-Interfaces-Figma-interactive/dp/180056418X/ref=sr_1_1_sspa",
                ...
                pt5: {
                    ...
                    l1: "https://codevoweb.com/build-a-trpc-crud-api-example-with-next-js/",
                    l2: "https://brockherion.dev/blog/posts/stop-building-rest-apis-for-your-next-apps/"
                },
                pt6: {
                    name: "SQL and Prisma",
                    ...
                    l1: "https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases-typescript-postgres",
                ...
                pt7: {
                    ...
                    l1: "https://pragprog.com/titles/tailwind2/modern-css-with-tailwind-second-edition/"
                },
                pt8: {
            ...
            `
                ...
                pt9: {
                    name: "Multi-Cloud GraphQL Serverless API Development with Cloud Development Kit for Terraform (CDKTF) (Remote Zoom Class)",
                    t1: "Learn Multicloud Serverless API Development using CDK Terraform in Baby Steps",
        ...
        quater3: {
            ...
            name: "$-101: Dollar Making Bootcamp - Full-Stack Template and API Product Development",
            duration: "13 Weeks",
            a: {
                name: "Build Full-Stack Next.js 13 Jamstack Templates",
                des: "You will be assigned to build a template which we will sell on Theme Forest and Panaverse DAO marketplace. The Panaverse DAO will receive 25% share on the sale of the template which will be used to manage the platform. An additional 15% will be spent on marketing the template. 60% of the revenues will be distributed to the developer through the Panaverse DAO in the form of Panaverse tokens.",
                t1: "The Template Standard",
                l1: "https://github.com/panaverse/panaverse-template-standard"
            },
            b: {
                name: "Build QraphQL APIs",
                des: "You will be assigned to build APIs for which you will sell subscriptions on the Panaverse DAO Marketplace. The Panaverse DAO will receive 25% share on the sale of the template which will be used to manage the platform. An additional 15% will be spent on marketing the template. 60% of the revenues will be distributed to the developer through the Panaverse DAO in the form of Panaverse tokens."
            }
        }
    }
];
     ...
     `,
          ...
          `,
                ...
                pt2: {
                    ...
                    p1: {
                        t1: "Solidity Programming Essentials - Second Edition By Ritesh Modi",
                        t2: "Solidity Learning Repo",
                        l1: "https://www.packtpub.com/product/solidity-programming-essentials-second-edition/9781803231181",
                        l2: "https://github.com/panaverse/defi-dapps-solidity-smart-contracts"
                    }
                },
                pt3: {
          ...
          `,
                    l1: "https://en.wikipedia.org/wiki/List_of_highest-funded_crowdfunding_projects",
                    ...
                    t5: "Top-Rated Crypto Token Sales: List of New ICOs, STOs, IEOs and IDOsTop-Rated Crypto Token Sales: List of New ICOs, STOs, IEOs and IDOs ",
                ...
                projects: [
                    {
                        ...
                        t2: "Your first task of the project is to make a google slides presentation on how to start a IEO on the Binance Launch Pad ",
                        l2: "https://www.binance.com/en/support/faq/94ed108ce89d44ab8602aa3c476dfb04"
                    },
                    {
                        id: 102,
                        title: "Project 2",
                        ...
                        t2: "Your second task of the project is to make a google slides presentation on how to start a IDO on the Polkastarter",
            ...
            `
                    },
                    {
                        ...
                        t1: "Read",
                        l1: "https://www.coindesk.com/tech/2020/11/10/multisignature-wallets-can-keep-your-coins-safer-if-you-use-them-right/",
                        t2: "Now use Gnosis Safe]{https://gnosis-safe.io/ with multi-sigs to do what you did in the last part.",
                  ...
                  `,
                        l1: "https://ethereum.org/en/developers/tutorials/send-token-etherjs/"
                    },
                    {
                        id: 107,
                        ...
                        l1: "https://ethereum.org/en/developers/tutorials/how-to-write-and-deploy-an-nft/",
                        t2: "Create a NFT contract using the [OpenZepplen ERC721 NFT Standard ",
                        ...
                        t4: "Deploy your NFT contract on a testnet, mint it, and view it on the MetaMask wallet and list it on OpenSea Marketplace https://opensea.io/  for sale.",
                        t5: "Implement a ERC721 Market ",
                        l5: "https://ethereum.org/en/developers/tutorials/how-to-implement-an-erc721-market/"
                    }
                ]
            }
        },
...
const common = [
    {
        ...
        subTitle: "Every participant of the program will start by completing the following three core courses",
        id: 1,
        quater1: {
            name: "Quarter I",
            code: "CS-101",
        ...
        quater2: {
            name: "Quarter II",
            code: "W2-201",
            des: "Developing Planet-Scale Web 2.0 Serverless Cloud Cloud Apps and APIs using Next.js 13 and Cloud Development Kit (CDK) for Terraform"
        },
        quater3: {
            name: "Quarter III",
            code: "$-101",
            des: " Dollar Making Bootcamp - Full-Stack Template and API Product Development"
        }
    }
];
